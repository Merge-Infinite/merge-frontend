...
import IconStakeFilled from "../../assets/icons/stake-filled.svg";
...
export default function CoinDetailPage() {
  ...
  return (
    ...
    >
      ...
      {isSUI && (
        <>
          <div className="balance details flex mt-2 mx-6 justify-between text-white">
      ...
      {network?.enableStaking && (
        <div className=" flex gap-4 w-full border-t border-t-zinc-100 ">
          {isSUI && (
            <Button
              type={"submit"}
              state={"primary"}
